# The combination of the range() function with the Python For Loop allows us to run a 
# loop for as many times as we wish. Instead of looping through each item in a List, 
