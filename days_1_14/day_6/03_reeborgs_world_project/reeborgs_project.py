...
# NOTE: This code attempt resulted in an infinite loop under certain maze conditions. 
#       After debugging, a more robust solution was developed. And you can find it on the same folder.